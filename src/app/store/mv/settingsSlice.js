...
const getDirection = (state) => state.mv.settings.current.direction;
const getMainTheme = (state) => state.mv.settings.current.theme.main;
const getNavbarTheme = (state) => state.mv.settings.current.theme.navbar;
const getToolbarTheme = (state) => state.mv.settings.current.theme.toolbar;
...
export const selectFuseCurrentSettings = ({ mv }) => mv.settings.current;

export const selectFuseCurrentLayoutConfig = ({ mv }) =>
  mv.settings.current.layout.config;

export const selectFuseDefaultSettings = ({ mv }) => mv.settings.defaults;

export const selectFuseThemesSettings = ({ mv }) => mv.settings.themes;
