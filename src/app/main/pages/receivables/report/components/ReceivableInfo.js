...
function ReceivableInfo({ info = {}, onCancelClick }) {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <label className="font-bold">{t("RECEIVABLE_STATUS")}:</label>
          <Chip
            className="mr-8"
            size="small"
      ...
      >
        ...
        <TextField
          sx={{ flex: 1 }}
          value={"61.200" || ""}
          label={t("CURRENT_EXCHANGE_RATE_REMITTANCE")}
          disabled
        />
        <TextField
          sx={{ flex: 1 }}
