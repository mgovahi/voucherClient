...
import ReceivableInfo from "./ReceivableInfo";
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <ReceivableInfo info={details.data.receivableInfo}></ReceivableInfo>
        </DialogContent>
      </Dialog>
    </>
  );
