...
window.appSettings.resources = {
  ...
  fa: {
    translation: {
      ...
      HOME: "خانه",
      DASHBOARD: "داشبورد",
      ADMINS_MANAGEMENT: "مدیریت راهبران",
      CLIENTS_MANAGEMENT: "مدیریت مشتریان",
      VOUCHERS: "حواله ها",
      ADMIN: "راهبران",
      VOUCHER: "حواله",
      REPORT: "گزارش دریافتنی ها",
      SETTING: "پیکربندی و تنظیمات",
      SETTING_MANAGEMENT: " مدیریت پیکربندی و تنظیمات",
      ...
      VOUCHER_SENTENCE: "در صورت نیاز به ایجاد حواله، آن را ایجاد نمایید.",
