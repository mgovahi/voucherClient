...
window.appSettings.resources = {
  en: {
    translation: {
      ...
      VOUCHER_GENERATE_HEADER_ACTION:
        "After the registration, your voucher is generated and the remittance code is provided to you.",
      VOUCHER_CODE_ALERT_ONE: "The Voucher code can be copied only once.",
      VOUCHER_CODE_ALERT_TWO:
        "The transfer code is confidential, please be careful when moving it and making it available.",
      VOUCHER_GENERATION_SUCCESS_ALERT: "Voucher was successfully generated!",
      VOUCHER_GENERATION_CODE_ALERT:
        "Your Voucher was created with the following code.",
      ...
      CANCEL_VOUCHER_CONFIRM_MESSAFE:
        "Are you sure about canceling the remittance?",
      YES: "yes",
      REMOVE_IP: "Remove IP",
  ...
  fa: {
    translation: {
      ...
      VOUCHER_CODE_ALERT_TWO:
        "کد حواله محرمانه است لطفا در جابجایی و در اختیار قرار دادن آن دقت نمایید.",
      ...
      PASSWORD_AND_CONFIRM_MISMATCH: "رمز عبور و تکرار آن یکسان نمی باشند",
    },
  },
};
